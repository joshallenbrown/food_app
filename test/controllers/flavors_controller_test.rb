...
class FlavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flavor" do
    assert_difference('Flavor.count') do
      post flavors_url, params: { flavor: { name: @flavor.name, price: @flavor.price, product_id: @flavor.product_id } }
    end
  ...
  test "should update flavor" do
    patch flavor_url(@flavor), params: { flavor: { name: @flavor.name, price: @flavor.price, product_id: @flavor.product_id } }
